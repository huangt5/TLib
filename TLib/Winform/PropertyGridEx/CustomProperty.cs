...
{
    [Serializable(), XmlRoot("CustomProperty")]
    ...
    {				
        ...
        [Category("Appearance"), DisplayName("Name"), Description("Display Name of the CustomProperty."), ParenthesizePropertyName(true), XmlElement("Name")]public string Name
        {
			get
			{
				return sName;
        ...
        [Category("Appearance"), DisplayName("ReadOnly"), Description("Set read only attribute of the CustomProperty."), XmlElement("ReadOnly")]public bool IsReadOnly
        {
			get
			{
				return bIsReadOnly;
        ...
        [Category("Appearance"), Description("Set visibility attribute of the CustomProperty.")]public bool Visible
        {
			get
			{
				return bVisible;
        ...
        [Category("Appearance"), Description("Represent the Value of the CustomProperty.")]public object Value
        {
			get
			{
				if (bRef)
        ...
        [Category("Appearance"), Description("Set description associated with the CustomProperty.")]public string Description
        {
			get
			{
				return sDescription;
        ...
        [Category("Appearance"), Description("Set category associated with the CustomProperty.")]public string Category
        {
			get
			{
				return sCategory;
        ...
        [Category("Behavior"), Description("Indicates if the property is browsable or not."), XmlElement(IsNullable = false)]public bool IsBrowsable
		{
			get
			{
				return bIsBrowsable;
		...
		[Category("Appearance"), DisplayName("Parenthesize"), Description("Indicates whether the name of the associated property is displayed with parentheses in the Properties window."), DefaultValue(false), XmlElement("Parenthesize")]public bool Parenthesize
		{
			get
			{
        ...
        [Category("Behavior"), Description("Indicates the style of the label when a property is browsable."), XmlElement(IsNullable = false)]public BrowsableTypeConverter.LabelStyle BrowsableLabelStyle
        {
			get
			{
        ...
        [Category("Behavior"), Description("Indicates if the property is masked or not."), XmlElement(IsNullable = false)]public bool IsPassword
        {
			get
			{
				return bIsPassword;
        ...
        [Category("Behavior"), Description("Indicates if the property represents a value in percentage."), XmlElement(IsNullable = false)]public bool IsPercentage
        {
			get
			{
        ...
        [Category("Behavior"), Description("Indicates if the property uses a FileNameEditor converter."), XmlElement(IsNullable = false)]public bool UseFileNameEditor
        {
			get
			{
        ...
        [Category("Behavior"), Description("Apply a filter to FileNameEditor converter."), XmlElement(IsNullable = false)]public string FileNameFilter
        {
			get
			{
				return sFilter;
        ...
        [Category("Behavior"), Description("DialogType of the FileNameEditor."), XmlElement(IsNullable = false)]public UIFilenameEditor.FileDialogType FileNameDialogType
        {
			get
			{
				return eDialogType;
        ...
        [Category("Behavior"), Description("Custom Choices list."), XmlIgnore()]public CustomChoices Choices
        {
			get
			{
				return oChoices;
