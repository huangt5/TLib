...
namespace TLib.Winform.PropertyGridEx
{
    [Serializable()]public class CustomPropertyCollection : System.Collections.CollectionBase, ICustomTypeDescriptor
	{
		...
		{
            List.Insert(0, new CustomProperty(strName, objValue, boolIsReadOnly, strCategory, strDescription, boolVisible));
		    return 0;
		}
		...
		{
            List.Insert(0, new CustomProperty(strName, ref objRef, strProp, boolIsReadOnly, strCategory, strDescription, boolVisible));
		    return 0;
		}
