...
namespace TLib.Winform.PropertyGridEx
{
    /// <summary>
    /// Refer to http://www.codeproject.com/Articles/13630/Add-Custom-Properties-to-a-PropertyGrid
    /// </summary>
	...
	{			
        ...
        [Category("Behavior"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Set the collection of the CustomProperty. Set ShowCustomProperties to True to enable it."), RefreshProperties(RefreshProperties.Repaint)]public CustomPropertyCollection Item
        {
			get
			{
		...
		[Category("Behavior"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Set the CustomPropertyCollectionSet. Set ShowCustomPropertiesSet to True to enable it."), RefreshProperties(RefreshProperties.Repaint)]public CustomPropertyCollectionSet ItemSet
        {
			get
			{
        ...
        [Category("Behavior"), DefaultValue(false), Description("Move automatically the splitter to better fit all the properties shown.")]public bool AutoSizeProperties
        {
			get
			{
        ...
        [Category("Behavior"), DefaultValue(false), Description("Use the custom properties collection as SelectedObject."), RefreshProperties(RefreshProperties.All)]public bool ShowCustomProperties
        {
			get
			{
        ...
        [Category("Behavior"), DefaultValue(false), Description("Use the custom properties collections as SelectedObjects."), RefreshProperties(RefreshProperties.All)]public bool ShowCustomPropertiesSet
        {
			get
			{
		...
		[Category("Appearance"), DefaultValue(false), Description("Draw a flat toolbar")]public new bool DrawFlatToolbar
        {
			get
			{
        ...
        [Category("Appearance"), DisplayName("Toolstrip"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Toolbar object"), Browsable(true)]public ToolStrip ToolStrip
        {
			get
			{
				return oToolStrip;
		...
		[Category("Appearance"), DisplayName("Help"), Description("DocComment object. Represent the comments area of the PropertyGrid."), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]public Control DocComment
		{
			get
			{
		...
		[Category("Appearance"), DisplayName("HelpTitle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Help Title Label."), Browsable(true)]public Label DocCommentTitle
		{
			get
			{
		...
		[Category("Appearance"), DisplayName("HelpDescription"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Description("Help Description Label."), Browsable(true)]public Label DocCommentDescription
		{
			get
			{
		...
		[Category("Appearance"), DisplayName("HelpImageBackground"), Description("Help Image Background.")]public Image DocCommentImage
		{
			get
			{
